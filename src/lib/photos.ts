 ...
 */
export const photos = {
  hero: { file: 'hero.jpg', label: 'Hero: convention crowd or chapter group, wide' },
  students: { file: 'students.jpg', label: 'Pre-law / law students, candid' },
  founders: { file: 'founders.jpg', label: 'Archival / founders era (black and white works)' },
